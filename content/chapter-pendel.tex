...
Die beiden Punkte werden dann in einer Liste festgehalten.
Über den Verlauf der nächsten Iterationen wird dieser Prozess wiederholt und die Listen weiter gefüllt.
