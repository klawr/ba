...
\begin{lstlisting}[language=JavaScript, caption={Definition des tests Objekt in der index.html.}\label{lst:tests_objekt}]
const tests = {
    pendel: {
        title: "Tests zum Finden des Drehpunkts bei einem gegebenen Glied.",
        indices: [5, 5, 2]
    },
    momentanpol: {
        title: "Tests zur Ermittlung des Momentanpols bei einem gegebenen Glied",
        indices: [3, 2]
},
    gruppe: {
        title: "Tests zum Segmentieren der Datenpunkte in mehrere Glieder.",
        indices: [2, 1, 1, 3]
    },
}
\end{lstlisting}
