...
\begin{figure}
    ...
    \caption[Versuch \name{pendel1\_3.html}]{Versuch \name{pendel1\_3.html}. Dieser Test versucht den Drehpunkt mittels des Erwartungswertes der Schnittpunkte aller Geraden, welche durch die in einer Iteration ermittelten am weitesten voneinander entfernten Punkte ermittelt werden.}
    \label{fig:pendel2_1}
\end{figure}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption[Daten der Versuche \name{pendel2\_1.html} und \name{pendel2\_2.html}]{Die Graphen zeigen jeweils die Verteilung der ermittelten Drehpunkte für die X- und Y-Achse. Orange ist jeweils der Y-Wert und Grün der X-Wert. Die darüber liegenden bläulichen Funktionen sind die entsprechenden Gauß-Verteilungen.
