...
Diese nutzt grö{\ss}tenteils die selbe Implentation wie die \lstinline{kMeansClustering} Funktion aus Kapitel~\ref{ch:kMeans}, jedoch wird hier eine andere Methode zur Ermittlung des nächsten \name{Centroids} der Punkte genutzt.
...
Dementsprechend wurde in Versuch \name{gruppe4\_1.html} versucht ein Viergelenk zu rekonstruieren, indem für ein Viergelenk die Absolutpole als jene definiert wurden, welche eine geringe Standardabweichung aufweisen, da davon auszugehen ist, dass andere Pole naturgemä{\ss} eine höhere aufweisen.
