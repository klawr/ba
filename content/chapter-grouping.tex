...
Die vorangegangen Methoden geben ansatzweise akzeptable Ergebnisse für Viergelenke.
...
Aus diesem Grund soll jetzt davon ausgegangen werden, dass die Ergebnisse ideal sind.
Aus diesen idealen Ergebnissen sollen nun die Gelenke ermittelt werden.
Hierbei wird also davon ausgegangen, dass sowohl die Regressionsgeraden für die Datenpunkte und die entsprechenden Momentanpole erfolgreich ermittelt wurden.
...
Hier lassen sich in jedem Fall die durch die in den angeführten Methoden bestimmten Momentanpole einzelner Gliedebenen ausschlie{\ss}en, wobei die Absolutpole dann direkt als gefundene Gelenke identifiziert werden können.
Entsprechend lassen sich nun $k - (2n - 1)$ Gelenke ausschlie{\ss}en.
Für ein Viergelenk bedeutet das, dass noch ein Relativpol übrig ist der nicht ausgeschlossen werden kann.
...
Eine Analyse des Momentanpols dieser Punkte würde diesen entsprechend in unendlicher Distanz äquivalent zur translativen Bewegung identifizieren.
Eine solche Bewegung kann in diesem Fall auch diese ausschlie{\ss}en.
