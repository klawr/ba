...
Hierfür soll das \lstinline{PointCloud} Objekt in einen vollständigen Graphen überführt werden, auf welchem dann über den \name{Dijkstra-Algorithmus} die kürzesten Pfade ermittelt.
...
Zur Durchführung des \name{Dijkstra} Algorithmus wurde die \lstinline{Dijkstra} Klasse definiert.
