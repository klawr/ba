...
\input{content/chapter-structure}      % INCLUDE: structure
\input{content/chapter-pendel}         % INCLUDE: pendel
\input{content/chapter-opticalflow}    % INCLUDE: optical-flow
\input{content/chapter-momentanpol}    % INCLUDE: momentanpol
\input{content/chapter-grouping}       % INCLUDE: grouping
